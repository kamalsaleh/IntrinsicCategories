...
n := HomalgMatrix( [ [ "x^2+y^2+y*z+y+z",
                       "3*x+5*y+7*z+10,2*x+4*y+6*z+8",
                       "-x^2-y^2-y*z-y-z",
                       "-3*x-5*y-7*z-10",
                       "-2*x-4*y-6*z-8" ] ], 6,1, R );
...
#! By a smaller presentation functor for Category of left 
#! presentations of Q[x,y,z]
...
#! functor for Category of left presentations of Q[x,y,z]
